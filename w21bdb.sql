...
INSERT INTO `quote` VALUES (1,2,'The unexamined life is not worth living'),(2,2,'There is only one good, knowledge, and one evil, ignorance'),(3,2,'Ooga booga me shooty da bug'),(4,3,'Bingo bango bongo I don\'t want to leave the congo');
...
BEGIN
	...
	inner join philosopher where `quote`.philosopher_id=philosopher.id and `quote`.philosopher_id=p_id_i;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2023-06-10 14:35:47
