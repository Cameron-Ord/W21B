...
INSERT INTO `philosopher` VALUES (2,'Socrates','Socrates (c. 469 - 399 B.C.) was a hugely important Greek philosopher from the Classical period (often known as the Socratic period in his honor). Unlike most of the Pre-Socratic philosophers who came before him, who were much more interested in establishing how the world works, Socrates was more concerned with how people should behave, and so was perhaps the first major philosopher of Ethics.','469 BC','399 BC','https://www.philosophybasics.com/photos/socrates.jpg');
...
INSERT INTO `quote` VALUES (1,2,'The unexamined life is not worth living'),(2,2,'There is only one good, knowledge, and one evil, ignorance');
...
BEGIN
	select id, name, bio, dob, dod, image_url from philosopher;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	select name, `quote`.id, content from `quote`
...
-- Dump completed on 2023-06-10 13:28:54
